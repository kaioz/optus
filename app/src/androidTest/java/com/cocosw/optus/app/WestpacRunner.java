 ...
 */
public class WestpacRunner extends AndroidJUnitRunner {
    ...
    public void onStart() {
        ...
        wakeLock.acquire();
        ((OptusApplication) InstrumentationRegistry.getInstrumentation().getTargetContext()
                .getApplicationContext()).service = new MockServiceProvider(app);
        super.onStart();
    }
